...
import (
	asset "github.com/withObsrvr/flow-proto/ingest/asset"
...
const file_ingest_processors_token_transfer_token_transfer_event_proto_rawDesc = "" +
	"\n" +
...
var (
	...
	file_ingest_processors_token_transfer_token_transfer_event_proto_rawDescData []byte
)
...
func file_ingest_processors_token_transfer_token_transfer_event_proto_rawDescGZIP() []byte {
	file_ingest_processors_token_transfer_token_transfer_event_proto_rawDescOnce.Do(func() {
		file_ingest_processors_token_transfer_token_transfer_event_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_ingest_processors_token_transfer_token_transfer_event_proto_rawDesc), len(file_ingest_processors_token_transfer_token_transfer_event_proto_rawDesc)))
	})
...
func file_ingest_processors_token_transfer_token_transfer_event_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_ingest_processors_token_transfer_token_transfer_event_proto_rawDesc), len(file_ingest_processors_token_transfer_token_transfer_event_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   0,
