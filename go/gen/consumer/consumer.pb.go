...
const file_consumer_consumer_proto_rawDesc = "" +
	"\n" +
	...
	"\aControl\x12\x1a.consumer.LifecycleRequest\x1a\x1b.consumer.LifecycleResponseB8Z6github.com/withObsrvr/flow-proto/gen/consumer;consumerb\x06proto3"

var (
	file_consumer_consumer_proto_rawDescOnce sync.Once
	file_consumer_consumer_proto_rawDescData []byte
)

func file_consumer_consumer_proto_rawDescGZIP() []byte {
	file_consumer_consumer_proto_rawDescOnce.Do(func() {
		file_consumer_consumer_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_consumer_consumer_proto_rawDesc), len(file_consumer_consumer_proto_rawDesc)))
	})
...
var file_consumer_consumer_proto_goTypes = []any{
...
func file_consumer_consumer_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_consumer_consumer_proto_rawDesc), len(file_consumer_consumer_proto_rawDesc)),
			NumEnums:      5,
			NumMessages:   21,
			NumExtensions: 0,
			NumServices:   1,
