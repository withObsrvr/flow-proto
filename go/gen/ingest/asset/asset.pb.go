...
func (x *Asset) GetNative() bool {
	if x, ok := x.GetAssetType().(*Asset_Native); ok {
		return x.Native
	}
	return false
}
...
func (x *Asset) GetIssuedAsset() *IssuedAsset {
	if x, ok := x.GetAssetType().(*Asset_IssuedAsset); ok {
...
var file_ingest_asset_asset_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x69, 0x6e, 0x67, 0x65,
	0x73, 0x74, 0x2f, 0x61, 0x73, 0x73, 0x65, 0x74, 0x3b, 0x61, 0x73, 0x73, 0x65, 0x74, 0x62, 0x06,
...
var file_ingest_asset_asset_proto_goTypes = []interface{}{
...
func file_ingest_asset_asset_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_ingest_asset_asset_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_ingest_asset_asset_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Asset); i {
			case 0:
				return &v.state
			case 1:
	...
	file_ingest_asset_asset_proto_msgTypes[1].OneofWrappers = []interface{}{
		(*Asset_Native)(nil),
